...
const ACHIEVEMENT_CATEGORIES: AchievementCategory[] = [
  {
    ...
    achievements: [
      ...
      },
      {
        ...
        xp: 150,
        description:
          "Visit three different gyms in the East (BFF Tampines OTH, BFF Yoha, Climb@T3, Upwall Climbing).",
        unlocked: false,
      },
      {
        ...
        xp: 150,
        description:
          "Visit three different gyms in the West (Boulder+ Chervons, Climb Central Chua Chu Kang, Fitbloc Depot Heights, Fitbloc Kent Ridge, Lighthouse Climbing, Z-Vertigo Boulder Gym).",
        unlocked: false,
      },
      {
        ...
        description:
          "Visit three different gyms in the North/North East (Boulder Planet Sembawang, Boulder Planet Taiseng, Boulder Movement Taiseng, Ark Bloc).",
        unlocked: false,
      },
      {
        id: "sendtral",
        ...
        xp: 150,
        description:
          "Visit three different gyms in Central Singapore (Kinetics Climbing, Ground Up Climbing, OYEYO Boulder Home, Boulder Movement Rochor, Climb Central Kallang, Outpost Climbing).",
        unlocked: false,
      },
      {
        id: "south",
        ...
        xp: 150,
        description:
          "Visit three different gyms in the South/CBD area (Climba, Boulder Movement Downtown, Boulder Movement Bugis, Climb Central Funan).",
        unlocked: false,
      },
      {
        id: "island-hopper",
        ...
        xp: 150,
        description:
          "Visit at least one gym in the North, South, East, West, and Central regions.",
        unlocked: false,
      },
      {
  ...
  },
  {
    ...
    achievements: [
      ...
      },
      {
        ...
        xp: 100,
        description:
          "Log a session on both Saturday and Sunday in the same weekend.",
        unlocked: false,
      },
      {
        id: "regular-showerf",
  ...
  },
  {
    ...
    achievements: [
      ...
      },
      {
        ...
        xp: 100,
        description:
          "Climb at the same gym with a friend for at least 2 hours.",
        unlocked: false,
      },
      {
        id: "squads",
        ...
        xp: 200,
        description:
          "Have a session where 4 or more mutual friends are at the same gym at the same time.",
        unlocked: false,
      },
      {
        id: "five-stack",
        ...
        xp: 300,
        description:
          "Send out a session invite that 4 or more people accept and actually attend.",
        unlocked: false,
      },
      {
        id: "full-lobby",
        ...
        xp: 1000,
        description:
          "Send out a session invite that 10 or more people accept and actually attend.",
        unlocked: false,
      },
      {
        id: "last-warning",
        ...
        xp: 1500,
        description:
          "Send out a session invite that 25 or more people accept and actually attend.",
        unlocked: false,
      },
      {
        id: "fifty-plus",
        ...
        xp: 5000,
        description:
          "Send out a session invite that 50 or more people accept and actually attend.",
        unlocked: false,
      },
      {
        ...
        description:
          "Invite a friend that you have not climbed with for at least 3 months, and actually attend.",
        unlocked: false,
      },
    ],
  },
    ...
    achievements: [
      {
        ...
        xp: 100,
        description:
          "Manually log a new max grade for the first time (e.g., moving from BM3 to BM4, or V3 to V4).",
        unlocked: false,
      },
      {
        id: "stoned",
        ...
        xp: 500,
        description:
          "Log 42 hours specifically at high-wall gyms (like Climb Central Sports Hub or Ground Up).",
        unlocked: false,
      },
      {
        id: "flash-master",
        ...
        xp: 250,
        description:
          "Log a session where you flashed a route at your max grade.",
        unlocked: false,
      },
      {
        ...
        description:
          "Log 10 benchmark problems on a system board of your choice.",
        unlocked: false,
      },
      {
        id: "creative-space",
      ...
      },
      {
        ...
        label: "Rock Solid",
        description:
          "Do 50 consecutive moves on the endurance wall/spray wall.",
        unlocked: false,
      },
      {
        id: "strong-contender",
    ...
    achievements: [
      {
        ...
        xp: 100,
        description:
          "Enter a gym when the app live map marks it as Very Crowded.",
        unlocked: false,
      },
      {
        id: "ghost-town",
        ...
        xp: 100,
        description:
          "Enter a gym when you are the only person using the app there.",
        unlocked: false,
      },
      {
      ...
      },
      {
        ...
        label: "The End?",
        description:
          "Climb at least one highest graded route in every gym in Singapore.",
        unlocked: false,
      },
      {
        ...
        label: "The beginning?",
        description:
          "Enter a local comp for the first time in any category (Novice-open).",
        unlocked: false,
      },
      {
        id: "the-beginning",
        ...
        label: "The beginning",
        description:
          "Win a local comp for the first time in any category (Novice-open).",
        unlocked: false,
      },
      {
        id: "the-end",
      ...
      },
      {
        ...
        description:
          "Enter and win an international comp of any discipline (boulder, lead, speed climb).",
        unlocked: false,
      },
      {
        id: "overkill",
        ...
        label: "Overkill",
        description:
          "Flash all the routes in a local comp for bouldering in any category.",
        unlocked: false,
      },
      {
        id: "over-overkill",
        ...
        label: "Over-Overkill",
        description:
          "Flash all the routes in an international comp for bouldering.",
        unlocked: false,
      },
    ],
  },
...
const ALL_ACHIEVEMENTS = ACHIEVEMENT_CATEGORIES.flatMap(
...
function generateWeeklyHoursData(sessions: ClimbingSession[]) {
  ...
  for (let i = 7; i >= 0; i--) {
    ...
    const totalMins = weekSessions.reduce(
...
function SessionCard({ session }: { session: ClimbingSession }) {
  ...
  return (
    <View
      style={[actStyles.sessionCard, { backgroundColor: cardBg, borderColor }]}
    >
      <View style={actStyles.sessionRow}>
        ...
        <View style={actStyles.sessionInfo}>
          <ThemedText style={actStyles.sessionGym}>
...
export default function ProfileScreen() {
  ...
  const profileTabSwipe = useMemo(
    () =>
      Gesture.Pan()
        ...
        .failOffsetY([-10, 10])
        .onUpdate((e) => {
          profileTabOffset.value =
            -profileTabIndex.value * screenWidth + e.translationX;
        })
        .onEnd((e) => {
          let target = profileTabIndex.value;
          if (
            (e.translationX < -150 || e.velocityX < -500) &&
            target < PROFILE_TABS.length - 1
          ) {
            target++;
          } else if (
            (e.translationX > 150 || e.velocityX > 500) &&
    ...
    [changeProfileTab, profileTabIndex, profileTabOffset, screenWidth],
  );
  ...
  const favGym = useMemo(() => {
    ...
    const topGymId = Object.entries(gymCounts).sort(
      ([, a], [, b]) => b - a,
    )[0]?.[0];
  ...
  const weeklyHours = useMemo(
    () => generateWeeklyHoursData(mySessions),
    [mySessions],
  );
  const monthlySends = useMemo(
    () => generateMonthlySendsData(mySessions),
    [mySessions],
  );
        ...
        >
          ...
          <View style={styles.statsGrid}>
            ...
            <View style={[styles.statCell, { backgroundColor: surfaceBg }]}>
              ...
              >
                <Text style={styles.favGymDotText}>
                  {favGym ? favGym.name[0] : "?"}
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={[styles.tabRow, { borderColor }]}>
            {(["insights", "activities", "progression"] as ProfileTab[]).map(
              (t) => (
                <Pressable
                  key={t}
                  style={[
                    styles.tabBtn,
                    profileTab === t && styles.tabBtnActive,
                  ]}
          ...
          <GestureDetector gesture={profileTabSwipe}>
            ...
            >
              <Reanimated.View
                style={[
                  { flexDirection: "row", width: screenWidth * 3 },
                  animatedProfileTabStyle,
                ]}
              >
                <View style={{ width: screenWidth, paddingHorizontal: 20 }}>
                  ...
                  <View style={styles.insightStatsRow}>
                    ...
                    >
                      ...
                      <ThemedText style={styles.insightStatLabel}>
                        Current Streak
                      </ThemedText>
                    </View>
                    <View
                ...
                <View style={{ width: screenWidth, paddingHorizontal: 20 }}>
                  <View style={styles.insightStatsRow}>
                    ...
                    >
                      <ThemedText style={styles.insightStatVal}>
                        {mySessions.length > 0
                          ? `${Math.round(stats.totalMinutes / mySessions.length)}m`
                          : "0m"}
                      </ThemedText>
                      <ThemedText style={styles.insightStatLabel}>
                        Avg Session
                ...
                <View style={{ width: screenWidth, paddingHorizontal: 20 }}>
                  ...
                  >
                    <View style={styles.levelHeader}>
                      <View>
                        <ThemedText style={styles.levelTierLabel}>
                          {levelInfo.tier}
                        </ThemedText>
                    ...
                    <View style={styles.xpBreakdown}>
                      <View style={styles.xpRow}>
                        ...
                        <ThemedText style={styles.xpRowVal}>
                          {stats.totalMinutes} XP
                        </ThemedText>
                      </View>
                      <View style={styles.xpRow}>
                        <ThemedText style={styles.xpRowLabel}>
                  ...
                  {ACHIEVEMENT_CATEGORIES.map((category) => {
                    const categoryUnlocked = category.achievements.filter(
                      (ach) => ach.unlocked,
                    ).length;
                    return (
                      <View
                        key={category.id}
                        style={styles.achievementCategorySection}
                      >
                        <View style={styles.achievementCategoryHeader}>
                          <ThemedText style={styles.achievementCategoryTitle}>
                            {category.title}
                          </ThemedText>
                            ...
                            <View style={styles.achievementInfo}>
                              ...
                              <ThemedText style={styles.achievementDescription}>
                                {category.hideDescription
                                  ? "Hidden badge. Unlock condition is secret."
                                  : ach.description}
                              </ThemedText>
                            </View>
...
const styles = StyleSheet.create({
  ...
  statLabel: { fontSize: 13, opacity: 0.5, marginTop: 6, textAlign: "center" },
  statValue: {
    fontSize: 20,
    fontWeight: "bold",
    marginTop: 4,
  ...
  tabLabel: { fontSize: 14, fontWeight: "600", textAlign: "center" },
  ...
  insightStatVal: { fontSize: 20, fontWeight: "bold", textAlign: "center" },
  insightStatLabel: {
    fontSize: 11,
    opacity: 0.5,
    marginTop: 2,
  ...
  xpRowLabel: { fontSize: 14, opacity: 0.7, flex: 1 },
  ...
  achievementCategoryTitle: { fontSize: 15, fontWeight: "700", flex: 1 },
